...
//  private static final int opc_jsr_w                  = 201;
    ...
    private byte[] generateClassFile() {
         ...
         *
         * 将所有我们要生成的字段和方法，组装成FieldInfo和MethodInfo类
         */
        try {
    ...
    private static void checkReturnTypes(List<ProxyMethod> methods) {
        ...
        for (ProxyMethod pm : methods) {
             ...
             * return types.
             * 将newReturnType与uncoveredReturnType进行比较
             */
            ...
            while (liter.hasNext()) {
                 ...
                 * 如果newReturnType为uncoveredReturnType的父类，保存uncoveredReturnType
                 */
                 ...
                 * 如果uncoveredReturnType为newReturnType的父类，保存newReturnType
                 */
             ...
             * 如果uncoveredReturnTypes列表与newReturnType没有可分配关系（不同类且非父子关系），
             * 则将newReturnType加到uncoveredReturnTypes列表中。
             */
            if (!added) {
